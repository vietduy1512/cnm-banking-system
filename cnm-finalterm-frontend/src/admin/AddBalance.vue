                ...
                <form @submit.prevent="processForm">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="user" v-model="user_id"
                                v-on:change="fetchAccounts(user_id)">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="account_number" v-model="account_number">
                        <option selected disabled>Choose Account</option>
                        <option v-for="account in accounts" :key="account.id" :value="account.account_number">
...
export default {
  ...
  methods: {
    ...
    fetchAccounts: function() {
      var requestUrl = API_URL + '/accounts/' + this.user_id;
      this.axios
        .get(requestUrl)
        .then(res => {
    ...
    processForm: function() {
      ...
      this.axios
        .post(API_URL + '/admin/addBalance', addBalanceModel)
        .then(res => {
            alert(res.data.msg);
